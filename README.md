...
3. فایل راه‌انداز زیر را اجرا کنید:
...
1. مخزن پروژه را دانلود کرده و فایل ZIP را از حالت فشرده خارج کنید.

2. فایل راه‌انداز برنامه را اجرا کنید:

```text
START.cmd
```

3. از منوی سمت چپ، وارد بخش ارائه‌دهندگان API شوید:

```text
API Providers
```

4. ارائه‌دهنده متناسب با کلید آزمایشی ارسال‌شده را انتخاب کنید.

برای مثال، اگر کلید مربوط به Groq باشد، گزینه زیر را انتخاب کنید:

```text
Groq
```

5. کلید API ارسال‌شده را در فیلد مربوطه وارد کنید.

6. برای دریافت فهرست مدل‌های در دسترس، گزینه زیر را انتخاب کنید:
...
8. برای بررسی اتصال، گزینه زیر را انتخاب کنید:
...
10. در صورت نیاز، ارائه‌دهنده را فعال کنید:

```text
Set active
```

11. وارد بخش گفت‌وگو شوید:

```text
Chat
```

12. یک پیام آزمایشی ارسال کنید.
